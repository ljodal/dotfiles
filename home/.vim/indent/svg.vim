...
call s:AddITags(['a', 'altGlyph', 'altGlyphDef', 'altGlyphItem', 'animate',
    ...
    \ 'missing-glyph', 'mpath', 'path', 'pattern', 'pattern', 'polyline', 'radialGradient',
    \ 'rect', 'script', 'set', 'stop', 'style', 'svg', 'switch', 'symbol', 'text',
